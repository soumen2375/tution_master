...
export default function TeacherFeesPage() {
  const summary = { totalExpected: 12500, totalCollected: 8500, totalPending: 4000 };
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                    <th className="pb-3">Student / Batch</th>
                    ...
                    <tr key={s.id} className="group hover:bg-secondary/20 transition-colors">
                      ...
                      <td className="py-4 text-center">
                        <span className={cn(
                          ...
                          s.status === 'PAID' && 'bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-400',
                          s.status === 'PENDING' && 'bg-orange-100 dark:bg-orange-950 text-orange-700 dark:text-orange-400',
                          s.status === 'OVERDUE' && 'bg-red-100 dark:bg-red-950 text-red-700 dark:text-red-400',
                          s.status === 'PARTIAL' && 'bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-400',
                        )}>
                          {s.status}
                        </span>
                      </td>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-white dark:bg-slate-800 border border-red-100">
                    <div>
